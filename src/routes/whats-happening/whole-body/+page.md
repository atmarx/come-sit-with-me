...
The metabolic shifts of perimenopause are real, and they may require different strategies than worked before. More on this in [Lifestyle Support](/support/lifestyle).

## Your Brain

I've written more about this in [What Your Brain Is Doing](/whats-happening/brain), but the short version: estrogen affects multiple neurotransmitter systems, supports the growth factor that keeps neurons healthy (BDNF), and influences verbal memory and processing speed.

[Brain fog](/symptoms/brain-fog) is real. Word-finding difficulties are real. The feeling that you're not as sharp as you used to be—real.
...
The good news: most of these changes can be supported. Some with [hormones](/support/hormone-therapy), some with [lifestyle changes](/support/lifestyle), some with [targeted medications](/support/beyond-hormones), some simply with time and patience.
