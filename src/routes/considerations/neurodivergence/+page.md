...
This isn't because autistic women are imagining things or being dramatic. It's because sensory processing differences are real, and symptoms that involve the body and its sensations—[hot flashes](/symptoms/hot-flashes), [skin changes](/symptoms/skin), [aches](/symptoms/aches), temperature dysregulation—land differently when your nervous system is wired differently.
...
Similarly:
- [Itching and skin changes](/symptoms/skin) may be more distressing
- [Sleep disruption](/symptoms/sleep-wont-come) may be harder to recover from
- [Brain fog](/symptoms/brain-fog) may compound existing executive function challenges
- [Mood changes](/symptoms/mood) may be harder to regulate when your baseline regulation takes effort
...
**Consider [your specific sensitivities](/support/lifestyle) in treatment choices.** If transdermal patches cause sensory distress, other delivery methods exist. If certain medications have intolerable side effects for your nervous system, alternatives may be available. Advocate for options that work with your neurology, not against it.
