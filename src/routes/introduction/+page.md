...
But I also carry knowledge that doesn't fit neatly into clinical trials. The [sage tea](/support/herbal-traditional) your great-grandmother swore by. The [Chinese medicine formula](/support/herbal-traditional) that's been refined over centuries. The way [movement and breath](/support/lifestyle) and ritual can settle a nervous system. These deserve more than dismissal, even when the randomized controlled trials haven't caught up.
